...
const items=[{label:'Bosh sahifa',href:'/',icon:Home},{label:'Sinflar',href:'/sinflar',icon:Users},{label:'Ish tekshirish',href:'/tekshirish',icon:ScanLine,primary:true},{label:'Natijalar',href:'/tarix',icon:History}];
